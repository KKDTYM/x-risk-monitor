...
const TARGET = 'Maibao1998';
const DEBUG = `${WS}/maibao_debug`;
...
(async () => {
  ...
  if (state.loginPrompt && state.tweets === 0) {
    console.log('[!] Cookies rejected — login prompt shown');
  ...
  fs.writeFileSync(`${WS}/data/maibao1998_tweets.json`, JSON.stringify(tweets, null, 2));
  ...
  fs.writeFileSync(`${WS}/data/maibao1998_profile.json`, JSON.stringify(profile, null, 2));
  console.log('\n--- PROFILE ---');
