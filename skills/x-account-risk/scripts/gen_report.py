...
<div class="container">
  <div class="header">
    ...
    <p>评估日期：{esc((meta.get('evaluated_at') or '')[:10])} ｜ 引擎：v4（9 维度） ｜ 数据源：{esc(meta.get('data_source') or '')}</p>
  </div>
  ...
  <div class="dimensions">
    <h2 class="section-title">📋 9 维度详细评分（含扣分标准）</h2>
    {cards}
  </div>
  ...
  <div class="footer">
    X 账号风险监控系统 v4（9 维度）｜ 数据来源：登录态 DOM 时间线 + X embed + fxTwitter ｜ 仅用于合规研究
  </div>
</div>
</body>
</html>"""
