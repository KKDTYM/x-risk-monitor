...
- 卖货/引流内容占比：非转帖推文中含卖货词（私信/口令/课表/门槛/报价/付费/电报/加群等）>=25% +3、>=50% +6
- 简介含 >=2 个卖货/引流词：+3
...
| 11 | **真人感/营销号形态** | 0-12 | 卖货内容 >=25% +3 / >=50% +6；简介卖货词 >=2 个 +3；生活化内容 <8% +3；搬运 >50% +3；生活化 >=25% -2 / >=50% -4。 |
